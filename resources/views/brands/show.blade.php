            ...
            <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-3">
                                    <h4 class="text-primary">{{ $brand->name }}</h4>
                                    @include('layouts.alert')

                                </div>
                                <a class="btn btn-danger text-light" data-bs-toggle="modal"
                                    data-bs-target="#modalEliminar">Eliminar marca</a>
                                <a class="btn btn-info text-light" data-bs-toggle="modal"
                                    data-bs-target="#modalEditar">Editar marca</a>
                            </div>
                ...
                <div class="row">
                    @if ($brand->products->isNotEmpty())
                        ...
                        @endforeach
                    @else
                        <h4 class="card-title mb-12">Sin productos</h4>
                    @endif
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Actualizar Marca</h1>
                                ...
                                <div class="row">
                                    <div>
                                        <button type="submit" class="btn btn-danger" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="delete">Eliminar marca</button>
                                    </div>
                                </div>
                                @if ($errors->any())
                                    <div class="alert alert-danger">
